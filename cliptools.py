...
~ There are a lot of weird / questionable 'hacks' (and many good ones!)
from GPT-5 in here now. Many not implemented. ~
"""
import os
import copy
import torch
...
#from clip.model import QuickGELU # If use 'import clip', must use QuickGELU thereof, else list index out of range error
...
class PromptAlignmentLoss(InvLoss):
    def __init__(self, clip_model, image: torch.Tensor, target_text_emb: torch.Tensor, text_coeff=0.5) -> torch.Tensor:
        super().__init__()
